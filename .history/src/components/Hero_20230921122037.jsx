...
const Hero = () => {
  ...
  "Find people who are in the same emotional state as you, connect with them,
  and help each other navigate life's ups and downs." 
  <br /> {/* Add a line break */}
  <span className="text-gradient" style={{ fontSize: '25px', padding: '50px', whiteSpace: 'nowrap', display: 'inline-block' }}>
    Low Price Therapy | Community | Clubs | Anonymous chat
  </span>
  <Button text="Chat Now" styles={/* Add your button styles here */} />
  <Button text="Learn More" styles={/* Add styles for the second button here */} />
</p>
