    ...
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 flex justify-start items-start flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-row justify-between items-center w-full">
          ...
          <div className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full" style={{ textShadow: '2px 2px 4px rgba(255, 255, 255, 0.8)' }}>
  Payment Method.
</div>
<p className={`${styles.paragraph} max-w-[470px] mt-5`} style={{ textShadow: '2px 2px 4px rgba(255, 255, 255, 0.8)' }}>
